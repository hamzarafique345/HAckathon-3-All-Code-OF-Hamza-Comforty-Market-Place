...
export default function Navbar() {
  ...
  return (
    <div className="flex flex-col text-white max-w-screen-2xl mx-auto">
      ...
      {/* Search Bar Section */}
      <div className="flex justify-between items-center px-0 sm:px-2 md:px-16 lg:px-40 py-4 gap-4 sm:gap-6 flex-col sm:flex-row">
        {/* Navigation Links */}
        <div className="flex  flex-col md:flex-row justify-between items-center gap-3 w-full md:w-auto">
          <ul className="flex flex-wrap justify-center md:gap-3 gap-1 text-xs sm:text-sm md:text-base text-black items-center relative w-full md:w-auto">
            <li>
              <a href={"/"}>Home</a>
            </li>
            <li>
